    ...
    public class SecondaryRectanglesInputManager
    {
        public static List<Rectangle> GetRectangles()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                if (SecondaryRectanglesInputManager.IsValidRectangle(topLeft, botLeft, botRight, topRight))
                {
                    rectangles.Add(new Rectangle(botLeft, topLeft, botRight, topRight, color));
            }
                else
            {
